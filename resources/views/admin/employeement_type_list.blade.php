                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-1">
                                            ...
                                            <a href="{{ route('admin.sub_employeement_type', ['id' => $item->emp_prefer_id]) }}"
                ...
                <form id="AddCountry"  onsubmit="return addCountry()">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="sub_prefer_id" value="0">
                ...
                success: function(res) {
                    ...
                    if (res.status == '2') {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{ route("admin.employeement_type") }}';
                        });
                    } else {
                        Swal.fire({
                            icon: 'error',
