            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tab-my-profile-setting" style="display: block;opacity:1;">
                    ...
                    <div class="card shadow-sm border-0 p-4 mt-30">
                      <h3 class="mt-0 color-brand-1 mb-2">Sector Preferences</h3>
    
                      <form id="sector_preferences_form" method="POST" onsubmit="return update_sector_preferences()">
                        @csrf
                        ...
                        <div class="form-group level-drp">
                          ...
                          <select class="form-input mr-10 select-active" name="sector_preferences">
                            ...
                            <option value="Public & Government" @if(!empty($work_preferences_data) && $work_preferences_data->sector_preferences == "Public & Government") selected @endif>Public & Government</option>
                            <option value="Private" @if(!empty($work_preferences_data) && $work_preferences_data->sector_preferences == "Private") selected @endif>Private</option>
                            <option value="Public Government & Private" @if(!empty($work_preferences_data) && $work_preferences_data->sector_preferences == "Public Government & Private") selected @endif>Public Government & Private</option>
                          </select>
                          <span id='reqsector_preferences' class='reqError text-danger valley'></span>
                        </div>
                        <div class="box-button mt-15">
                          <button class="btn btn-apply-big font-md font-bold" type="submit" id="submitSectorPreferences">Save Changes</button>
                        </div>
                      </form>
