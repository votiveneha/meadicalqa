<div class="sidebar_profile">
    ...
    <div class="box-nav-tabs nav-tavs-profile mb-5 p-0 profile-icns">
      <ul class="nav" role="tablist">
        ...
        <li><a class="{{ request()->is('nurse/WorkShiftPreferences') ?'active':'' }} btn btn-border recruitment-icon mb-20 profile_tabs" href="{{ route('nurse.WorkShiftPreferences', ['page' => 'WorkShiftPreferences']) }}" aria-controls="tab-my-profile-setting" aria-selected="false"><i class="fi fi-rr-calendar-clock"></i> Work-Life Balance & Shift Preferences</a></li>
        <li><a class="btn btn-border recruitment-icon mb-20 profile_tabs" href="#" aria-controls="tab-my-profile-setting" aria-selected="false"><i class="fi fi-rr-id-badge"></i> Position Preferences</a></li>
        <li><a class="btn btn-border recruitment-icon mb-20 profile_tabs" href="#" aria-controls="tab-my-profile-setting" aria-selected="false"><i class="fi fi-rr-shield-check"></i> Benefits Preferences</a></li>
        <li><a class="btn btn-border recruitment-icon mb-20 profile_tabs" href="#" aria-controls="tab-my-profile-setting" aria-selected="false"><i class="fi fi-rr-building"></i> Location Preferences</a></li>
