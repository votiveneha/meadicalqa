...
<div class="form-group level-drp">
        ...
        <div class="card shadow-sm border-0 p-4 mt-30">
                ...
                <form id="educert_form" method="POST" enctype="multipart/form-data"  novalidate onsubmit="return educert()">
                  @csrf
                  <?php
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                           <div class="form-group level-drp">
                        <input class="form-control"  id="testimg" type="file" name="test_img[]" multiple="">
                  </div>
                      </div>
                      <div id="previewContainer">
                        ...
                        @if(!empty($educationData) && $educationData->test_data)
                          ...
                          $d_img = json_decode($educationData->test_data) ?? [];
                          //print_r($dtran_img);
                          $i = 1;
                          $user_id = Auth::guard('nurse_middle')->user()->id;
                        ?>
          ...
          if(acls_certification_array.includes(selectedValues[i]) == false){
            ...
            <div class="acls_${res_one} cert_div_${selected_text}">
              ...
              <div class="license_number_div row license_number_additional">
                ...
                <div class="form-group col-md-6">
                  <label class="form-label" for="input-1">Upload your certification/Licence</label>
                  <input class="form-control acls_upload_certification acls_imgs_${res_one} acls_upload_certification-${i}" type="file" name="acls_upload_certification[${i}][]" onchange="changeImg1(${user_id}, ${i}, '${img_text}', '${res_one}')" multiple>
                  <span id="reqaclsuploadvalid-${i}" class="reqError text-danger valley"></span>
                  <div class="acls_imgse${res_one}"></div>
                </div>

                <div class="form-group col-md-6">
                  <label class="form-label" for="input-1">Upload your certification/Licence</label>
                  <input class="form-control acls_upload_certification acls_imgs_${res_one} acls_upload_certification-${i}" type="file" name="acls_upload_certification[${i}][]"  multiple onchange="previewFiles(event, ${i}, '${res_one}')">
                  <span id="reqaclsuploadvalid-${i}" class="reqError text-danger valley"></span>
...
<script>
cconst fileInput12 = document.getElementById('testimg');
...
fileInput12.addEventListener('change', (e) => {
