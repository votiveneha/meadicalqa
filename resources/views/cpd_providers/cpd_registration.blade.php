		  ...
		  <form id="multi-step-form">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 mx-auto">
              <div class="text-start">
                ...
                <h2 class="mt-10 mb-5 text-brand-1" style="line-height: 1.6em;">CPD/CE Providers Registration</h2>
              </div>
              <div class="login-register text-start mt-20" action="#">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                  <label class="form-label" for="input-1">CPD/CE Providers Name *</label>
                  <input class="form-control" id="input-1" type="text" required="" name="fullname" placeholder="Steven Job">
                </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                  <label class="form-label" for="input-2">CPD/CE Providers Email *</label>
                  <input class="form-control" id="input-2" type="email" required="" name="emailaddress" placeholder="stevenjob@gmail.com">
                </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                  <label class="form-label" for="input-3">CPD/CE Providers Mobile No *</label>
