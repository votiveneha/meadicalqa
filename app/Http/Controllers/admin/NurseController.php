...
class NurseController extends Controller
{
    ...
    public function viewProfile(Request $request)
    {
        try {
            ...
            return view('admin.profile-view',compact('profileData','experienceData','policeCheckVerificationData','eligibilityToWorkData','workingChildrenCheckData','educationData'));
        } catch (\Exception $e) {
